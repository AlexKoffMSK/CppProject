...
namespace WorkWithTextFiles
{
	void ExampleRead1()
	{
		...
		std::string s;
		ifs >> s; 
		//из файла первое слово (до пробела) в переменную s. Считали первое слово, подвинули курсор. 
		//Считывает до пробельного символа (пробел, табуляция, переход на новую строку)
		cout << s << endl;
	...
	void ExampleRead4()
	{
		...
		int a;
		while (ifs >> a) //пока есть что считывать. считываение определяется ">>"
		{
			cout << a << endl;
		}
	}
	...
	//сериализация данных - запись программной структуры данных на диск, преобразование структуры данных в файл
	//десериализация данных - наоборот. чтение структуры данных из файла.
